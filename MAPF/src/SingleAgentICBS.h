...
public:
    ...
    int getHeuristic(int label,int location, int heading );
    int getPenalty(int label,int time,int location, int heading );
    ...
    SingleAgentICBS(int start_location, vector<int> goal_location, Map* ml, int agent_id, int start_heading = -1, int kRobust = 0, vector<int> min_end = vector<int>());
	~SingleAgentICBS();
